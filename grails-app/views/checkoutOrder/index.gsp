...
<html>
	...
	<body>
		<a href="#list-checkoutOrder" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-checkoutOrder" class="content scaffold-list" role="main">
			...
			<thead>
				...
				<g:each in="${checkoutOrderInstanceList}" status="i" var="checkoutOrderInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: checkoutOrderInstance, field: "customer")}</td>
			...
			<div class="pagination">
				<g:paginate total="${checkoutOrderInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
