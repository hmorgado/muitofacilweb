	...
	<body>
		...
		<div id="show-customer" class="content scaffold-show" role="main">
			...
			<ol class="property-list customer">
				...
				<g:if test="${customerInstance?.cnpj}">
				<li class="fieldcontain">
					<span id="cnpj-label" class="property-label"><g:message code="customer.cnpj.label" default="Cnpj" /></span>
					
						<span class="property-value" aria-labelledby="cnpj-label"><g:fieldValue bean="${customerInstance}" field="cnpj"/></span>
