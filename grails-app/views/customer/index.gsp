		...
		<div id="list-customer" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="cnpj" title="${message(code: 'customer.cnpj.label', default: 'Cnpj')}" />
				...
				<g:each in="${customerInstanceList}" status="i" var="customerInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${customerInstance.id}">${fieldValue(bean: customerInstance, field: "cnpj")}</g:link></td>
