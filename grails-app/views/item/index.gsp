		...
		<div id="list-item" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="obs" title="${message(code: 'item.obs.label', default: 'Obs')}" />
				...
				<g:each in="${itemInstanceList}" status="i" var="itemInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${itemInstance.id}">${fieldValue(bean: itemInstance, field: "obs")}</g:link></td>
